package iis.production.musingo.billing;
...
import static iis.production.musingo.billing.C.ACTION_NOTIFY;
import static iis.production.musingo.billing.C.ACTION_PURCHASE_STATE_CHANGED;
import static iis.production.musingo.billing.C.ACTION_RESPONSE_CODE;
import static iis.production.musingo.billing.C.INAPP_REQUEST_ID;
import static iis.production.musingo.billing.C.INAPP_RESPONSE_CODE;
import static iis.production.musingo.billing.C.INAPP_SIGNATURE;
import static iis.production.musingo.billing.C.INAPP_SIGNED_DATA;
import static iis.production.musingo.billing.C.NOTIFICATION_ID;
